        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La democracia, como sistema político, ha evolucionado desde sus orígenes en la Atenas clásica hasta convertirse en un modelo representativo que garantiza derechos fundamentales y promueve la participación ciudadana. Su relación con la constitución asegura equilibrio entre poder y derechos, fomentando justicia, igualdad y cohesión social. A pesar de los desafíos contemporáneos como la desinformación y la desigualdad, la democracia sigue siendo una herramienta esencial para construir sociedades justas y participativas.
              
              p #[b "Cada voto y cada voz cuentan en la construcción del futuro."]
